                    ...
                    <div class="row container">
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action=" {{route('master_pegawai.update',$item->id)}} ">
                                        @csrf
                                        @method('put')
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <input id="NIP" type="text" class="form-control @error('NIP') is-invalid @enderror" name="NIP" value="{{ $item->NIP }}" required autocomplete="NIP" autofocus>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <select name="wilayah_id" id="wilayah_id" class="form-control" required>
                                                    <option value=" {{$item->wilayah_id}} ">{{$item->masterwilayah_tabel->nama_wilayah}}</option>
                                                        @foreach ($wilayah_item as $wilayah_item)
                                                        <option value="{{ $wilayah_item->wilayah_id }}">{{ $wilayah_item->nama_wilayah }}</option>
                                                        @endforeach
                                                </select>
                                            </div>
                                        </div>
