    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h3 class="mt-4">Tambah Pasien</h3>
                        ...
                        <div class="col">
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    ...
                                    <form action="{{route('menu_pasien.store')}}" class="row g-3 needs-validation" novalidate method="POST">
                                        @csrf
                                        <div class="col-md-4">
                                            <label for="validationCustom01" class="form-label">No KTP</label>
                                            <input type="text" name="NIK" class="form-control" id="validationCustom01" value="" required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="nama_pasien" class="form-control" id="validationCustom02" value="" required>
                                            <div class="valid-feedback">
                                            Looks good!
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="no_phone" class="form-control" id="validationCustom02" value="" required>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="date" name="tanggal_lahir" class="form-control" id="validationCustom02" value="" required>
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <label for="validationCustom02" class="form-label">Pilih Pegawai</label>
                                            <select class="form-select" name="pegawai_id" required class="form-control">
                                                <option required value="pegawai_id">Pilih Pegawai</option>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="keluhan" id="keluhan" value="" required>
                                            <div class="valid-feedback">
                                            Looks good!
                                            </div>
                                        </div>
